...
res_exCorreclated<-read_process('res_exCorrelated','less correclated')
...
testmse<-ggplot(data = t[t$variable=='test_mse',],aes(x=Approach,y=value,group=Models,color=Models))+
  geom_line(linewidth=1.5)+labs(title='Test squared error',fill='Models')+theme(legend.title = element_text(size=15),
...
csvmse<-ggplot(data = t[t$variable=='csv_mse',],aes(x=Approach,y=value,group=Models,color=Models))+
  geom_line(linewidth=1.5)+labs(title='CV mean squared error',fill='Models')+theme(legend.title = element_text(size=15),
                                                                      legend.text = element_text(size=15),
                                                                      legend.key.size = unit(1, 'cm'),
                                                                      axis.text.y = element_text(colour = 'black', size = 12), 
                                                                      axis.title.y = element_blank(),
...
accuracy<-ggplot(data = t[t$variable=='accuracy',],aes(x=Approach,y=value,group=Models,color=Models))+
  geom_line(linewidth=1.5)+labs(title='Accuracy',fill='Models')+theme(legend.title = element_text(size=15),
                                                         legend.text = element_text(size=15),
                                                         legend.key.size = unit(1, 'cm'),
                                                         axis.text.y = element_text(colour = 'black', size = 12), 
                                                         axis.title.y = element_blank(),
